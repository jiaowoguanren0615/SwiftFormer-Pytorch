...
@register_model
def SwiftFormer_XS(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None,  **kwargs):
    model = SwiftFormer(
...
@register_model
def SwiftFormer_S(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = SwiftFormer(
...
@register_model
def SwiftFormer_L1(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = SwiftFormer(
...
@register_model
def SwiftFormer_L3(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model = SwiftFormer(
...
#
#     net = SwiftFormer_XS(num_classes=5)
